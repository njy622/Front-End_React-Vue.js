...
export default function MovieHeader({onMobieData}) {

    const handleMovieLinkClick = (linkId, e) => {
        e.preventDefault();
        // console.log(linkId);
        onMobieData(linkId);
        ...
        <header>
            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                ...
                <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">리액트 무비 앱(남지영)</span>
                </a>
